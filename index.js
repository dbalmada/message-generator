...
createMessage.addEventListener('click', function(){
    ...
    messageBox.innerText = message.articles[randomNum] + ' ' + message.subjectOne[randomNum] + ' ' + message.verbs[randomNum] + ' ' + message.connector[randomNum] + ' ' + message.subjects[randomNum]
})
